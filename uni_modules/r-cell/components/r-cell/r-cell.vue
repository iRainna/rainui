<template>
	...
	>
		...
		<view v-else-if="icon && !$slots.icon" class="r-cell__left-icon">
			<r-icon :name="icon" size="inherit" color="inherit" :prefix="iconPrefix"></r-icon>
		</view>
		...
		<view class="r-cell__right-icon" v-else-if="isLink">
			<r-icon :name="`${arrowDirection != 'right' ? 'arrow-' + arrowDirection : 'arrow'}`" size="inherit" color="inherit"></r-icon>
		</view>
